function dispinfo(x,y)
    ...
    love.graphics.print("Perso Y1 = "..steve.Y1,x+10,y+50)
    love.graphics.print("Perso tileX = "..steve.X1/resolution,x+300,y+30)
    love.graphics.print("Perso tileY = "..steve.Y1/resolution,x+300,y+50)
